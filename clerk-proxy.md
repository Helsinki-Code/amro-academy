...
lastUpdated: 2025-12-18T23:02:42.000Z
sdkScoped: "false"
canonical: /docs/guides/dashboard/dns-domains/proxy-fapi
sourceFile: /docs/guides/dashboard/dns-domains/proxy-fapi.mdx
---
...
<Steps>
  ...
  * Using properties in your application
  ...
  <Tabs items={["Next.js", "Remix", "JavaScript"]}>
    <Tab>
      To configure your proxy setup using properties in your Next.js application, set the `proxyUrl` property on the <SDKLink href="/docs/:sdk:/reference/components/clerk-provider" sdks={["chrome-extension","expo","nextjs","react","react-router","tanstack-react-start"]} code={true}>\<ClerkProvider></SDKLink> component.
    ...
    <Tab>
      To configure your proxy setup using properties in your Remix application, set the `proxyUrl` property on the <SDKLink href="/docs/reference/remix/clerk-app" sdks={["remix"]} code={true}>ClerkApp</SDKLink> wrapper.
    ...
    <Tab>
      To configure your proxy setup using properties in your JavaScript application, pass the `proxyUrl` option to the <SDKLink href="/docs/reference/javascript/clerk#load" sdks={["js-frontend"]} code={true}>load()</SDKLink> method.
